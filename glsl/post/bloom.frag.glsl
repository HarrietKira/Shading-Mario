...
// TODO
const float kernel[] = float[121] (0.006849, 0.007239, 0.007559, 0.007795, 0.007941, 0.00799,  0.007941, 0.007795, 0.007559, 0.007239, 0.006849,
...
void main()
{
    ...
    for (int i = -5; i < 6; i++)
    {
        for (int j = -5; j < 6; j++)
        {
            ...
            {
                color0 += kernel[(j + 5) + (i + 5) * 11] * c;
            }
        }
    }
    color = color0 + texture(u_RenderedTexture, fs_UV).rgb;
}
