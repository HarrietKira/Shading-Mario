...
{
    // TODO: update unifCam
    mp_progSurfaceCurrent->updateCamPos(m_camera.eye);
...
void MyGL::createShaders()
{
    ...
    // TODO
    std::shared_ptr<PostProcessShader> shakeShake = std::make_shared<PostProcessShader>(this);
    shakeShake->create(":/glsl/post/passthrough.vert.glsl", ":/glsl/post/shake.frag.glsl");
    m_postprocessShaders.push_back(shakeShake);
